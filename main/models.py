...
def user_directory_path(instance, filename):
    # file path for uploading files based on user-specific info
    # instance -- model instance file is associated with
...
class Vendor(models.Model):
    ...
    # description = models.TextField(null=True, blank=True, default='A trial will convince you')
    description = RichTextUploadingField(null=True, blank=True, default='A trial will convince you')
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True) # retains vendor on user object deletion (opposite of CASCADE)
...
class Product(models.Model):
    ...
    title = models.CharField(max_length=100, default='Fresh Avocado')
...
class ProductImages(models.Model):
    '''For more than 1 image for a product'''
...
class CartOrder(models.Model):
    ...
    coupon = models.ManyToManyField("main.Coupon", blank=True)
